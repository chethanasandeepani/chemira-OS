;chemiraOS --- The chemira Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE chemiraOS_VER '1.0.0'	 ;OS version number
	%DEFINE chemiraOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	mov cx, 11101100b		; Colour: white text on light blue
	...
	os_init_msg		db 'Welcome to chemira OS ...', 0
	os_version_msg		db 'Version ', chemiraOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', chemiraOS_VER, 0

	dialog_string_1		db 'Welcome to chemira Operating System', 0
	dialog_string_2		db '* select INFO for HardwareInfo or', 0
